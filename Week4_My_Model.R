...
Combined_QB <- Combined_QB %>% 
  mutate(ex_pas_yds = ovr_ex_pas_yds.x*Prior_Weight + ovr_ex_pas_yds.y*This_Year_Weight,
         ex_pas_td = ovr_ex_pas_td.x*Prior_Weight + ovr_ex_pas_td.y*This_Year_Weight,
         ex_rus_yds = ovr_ex_rus_yds.x*Prior_Weight + ovr_ex_rus_yds.y*This_Year_Weight, 
         ex_rus_td = ovr_ex_rus_td.x*Prior_Weight + ovr_ex_rus_td.y*This_Year_Weight, 
         ex_fmb = (fl/17)*Prior_Weight + fmb_scrim*This_Year_Weight,
         ex_int = pl_int_game*Prior_Weight + Int_pas*This_Year_Weight) %>% 
...
Combined_RB <- Combined_RB %>% 
  mutate(ex_rus_yds = ovr_ex_rus_yds.x*Prior_Weight + ovr_ex_rus_yds.y*This_Year_Weight, 
         ex_rus_td = ovr_ex_rus_td.x*Prior_Weight + ovr_ex_rus_td.y*This_Year_Weight, 
         ex_rec = ovr_ex_rec.x*Prior_Weight + ovr_ex_rec.y*This_Year_Weight,
         ex_rec_yds = ovr_ex_rec_yds.x*Prior_Weight + ovr_ex_rec_yds.y*This_Year_Weight,
         ex_rec_td = ovr_ex_rec_td.x*Prior_Weight + ovr_ex_rec_td.y*This_Year_Weight,
         ex_fmb = (fl/17)*Prior_Weight + fmb_scrim*This_Year_Weight) %>% 
...
Combined_Receiving <- Combined_Receiving %>% 
  mutate(ex_rec = ovr_ex_rec.x*Prior_Weight + ovr_ex_rec.y*This_Year_Weight,
         ex_rec_yds = ovr_ex_rec_yds.x*Prior_Weight + ovr_ex_rec_yds.y*This_Year_Weight,
         ex_rec_td = ovr_ex_rec_td.x*Prior_Weight + ovr_ex_rec_td.y*This_Year_Weight,
         ex_fmb = (fl/17)*Prior_Weight + fmb_scrim*This_Year_Weight) %>% 
