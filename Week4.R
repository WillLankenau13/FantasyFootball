...
Passing <- read_csv("~/R Stuff/FantasyFootball/Weeks/Weeks_1_3/Passing.csv")
Scrimmage <- read_csv("~/R Stuff/FantasyFootball/Weeks/Weeks_1_3/Scrimmage.csv") %>% 
  row_to_names(row_number = 1) %>% 
  clean_names 
Defense <- read_csv("~/R Stuff/FantasyFootball/Weeks/Weeks_1_3/Defense.csv") %>% 
  row_to_names(row_number = 1) %>% 
  clean_names 
Team_Offense <- read_csv("~/R Stuff/FantasyFootball/Weeks/Weeks_1_3/Team_Offense.csv") %>% 
  row_to_names(row_number = 1) %>% 
  clean_names 
