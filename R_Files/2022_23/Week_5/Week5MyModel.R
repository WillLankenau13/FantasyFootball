...
QB_Expected_Points_Prior <- read_csv((eval(paste("~/R Stuff/FantasyFootball/Prior/Week_", Char_Week, "/Week_", Char_Week, "_QB_Prior.csv", sep = ""))))
RB_Expected_Points_Prior <- read_csv((eval(paste("~/R Stuff/FantasyFootball/Prior/Week_", Char_Week, "/Week_", Char_Week, "_RB_Prior.csv", sep = ""))))
Receiving_Expected_Points_Prior <- read_csv((eval(paste("~/R Stuff/FantasyFootball/Prior/Week_", Char_Week, "/Week_", Char_Week, "_Rec_Prior.csv", sep = ""))))

QB_Expected_Points <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Input/Week_", Char_Week, "/Week_", Char_Week, "_QB_Input.csv", sep = "")))
RB_Expected_Points <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Input/Week_", Char_Week, "/Week_", Char_Week, "_RB_Input.csv", sep = "")))
Receiving_Expected_Points <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Input/Week_", Char_Week, "/Week_", Char_Week, "_Rec_Input.csv", sep = "")))
...
Simple_QB <- Combined_QB %>% 
  select(player, Position_yah, Opponent_yah, expected_points, Salary_yah, home_away) %>% 
...
Simple_Flex <- Simple_Flex %>% 
  ...
  mutate(adj_expected_points = ifelse(home_away == "Home", 
