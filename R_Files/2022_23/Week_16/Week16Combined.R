...
Online_TE <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Online_Models/Week_", Char_Week, "/FantasyPros_2022_Week_", Char_Week ,"_TE_Rankings.csv", sep = ""))) %>% 
  select(c(-1))
Online_DST <- read_csv(eval(paste("~/R Stuff/FantasyFootball/Online_Models/Week_", Char_Week, "/FantasyPros_2022_Week_", Char_Week ,"_DST_Rankings.csv", sep = ""))) %>% 
  select(c(-1))
...
names(Online_DST)[1] <- 'defense'
names(Online_DST)[6] <- 'proj_points'
Combined_DST <- left_join(Online_DST, Yahoo, by = c("defense" = "full_name_yah"))
...
write_csv(Combined_DST, eval(paste("~/R Stuff/FantasyFootball/Combined_Model_Online_Results/Week_", Char_Week, "/Combined_Model_Online_Week_", Char_Week ,"_DST.csv", sep = "")))
