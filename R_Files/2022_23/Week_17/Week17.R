...
write_csv(QB_Expected_Points, (eval(paste("~/R Stuff/FantasyFootball/Middle/Week_", Char_Week, "/Week_", Char_Week, "_QB_Input.csv", sep = ""))))
write_csv(RB_Expected_Points, (eval(paste("~/R Stuff/FantasyFootball/Middle/Week_", Char_Week, "/Week_", Char_Week, "_RB_Input.csv", sep = ""))))
write_csv(Receiving_Expected_Points, (eval(paste("~/R Stuff/FantasyFootball/Middle/Week_", Char_Week, "/Week_", Char_Week, "_Rec_Input.csv", sep = ""))))
