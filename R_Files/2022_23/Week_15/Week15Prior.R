...
write_csv(QB_Expected_Points_Prior, (eval(paste("~/R Stuff/FantasyFootball/Prior/Week_", Char_Week, "/Week_", Char_Week, "_QB_Prior.csv", sep = ""))))
write_csv(RB_Expected_Points_Prior, (eval(paste("~/R Stuff/FantasyFootball/Prior/Week_", Char_Week, "/Week_", Char_Week, "_RB_Prior.csv", sep = ""))))
write_csv(Receiving_Expected_Points_Prior, (eval(paste("~/R Stuff/FantasyFootball/Prior/Week_", Char_Week, "/Week_", Char_Week, "_Rec_Prior.csv", sep = ""))))
