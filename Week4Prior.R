...
Yahoo <- read_csv("~/R Stuff/FantasyFootball/Yahoo/Week_4_Yahoo.csv") %>% 
  select(ID:Starting) %>% 
...
write_csv(QB_Expected_Points_Prior, "~/R Stuff/FantasyFootball/R_Interim_Data/QB_Expected_Points_Prior.csv")
write_csv(RB_Expected_Points_Prior, "~/R Stuff/FantasyFootball/R_Interim_Data/RB_Expected_Points_Prior.csv")
write_csv(Receiving_Expected_Points_Prior, "~/R Stuff/FantasyFootball/R_Interim_Data/Receiving_Expected_Points_Prior.csv")
